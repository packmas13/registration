# Generated by Django 3.0.2 on 2020-02-27 12:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_main', models.BooleanField(default=True, verbose_name='main day')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age_section', models.CharField(blank=True, choices=[(None, 'no section'), ('beaver', 'beaver'), ('cub', 'cub'), ('scout', 'scout'), ('venturer', 'venturer'), ('rover', 'rover')], max_length=16, verbose_name='age section')),
